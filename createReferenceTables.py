...
player = dataReader.readPlayerData()[0]
...
dataStore.create_zoi_completion_table(cursor)
dataStore.create_player_table(cursor)
dataStore.create_model_table(cursor)
...
#dataStore.populate_players_table(cursor, player)
connection.commit()